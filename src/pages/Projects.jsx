        ...
        <div className="projects-page">
            ...
            <div className="project-row">
                <div className="project-text">
                    ...
                    <ul>
                        ...
                        <li>
                            <strong>Vanilla JavaScript</strong> - Data loading, DOM
                            manipulation, search & filtering logic
                        </li>
                        <li>
                ...
                <div className="project-image">
                    ...
                    >
                        <img
                            src={pixarGallery}
                            alt="Pixar Movie Gallery Screenshot"
                        />
            ...
            <div className="project-row">
                <div className="project-text">
                    ...
                    <p className="tech-stack">
                        <strong>Tech:</strong> Java, Swing (or JavaFX), File I/O, MVC
                        architecture
                    </p>
            ...
            <div className="project-row">
                <div className="project-text">
                    ...
                    <ul>
                        <li>
                            <strong>Front-End:</strong> JSP, jQuery, AJAX, Chart.js
                        </li>
                        <li>
                            <strong>Back-End:</strong> Java Spring (Controller, Mapper), MyBatis
                        </li>
                        <li>
                            <strong>Database:</strong> MySQL
                        </li>
                        <li>
                            <strong>Machine Learning:</strong> Python, TensorFlow (CNN for food
                            image recognition)
                        </li>
                        <li>
                            <strong>APIs & Crawling:</strong> YouTube API, Selenium, DeepSearch
                            API
                        </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>
                            Personalized diet, recipe, and workout recommendations
                        </li>
                        <li>
                            Daily diary with calorie & macronutrient visualization (Chart.js)
                        </li>
                        <li>
                            News and exercise video crawling with real-time updates
                        </li>
